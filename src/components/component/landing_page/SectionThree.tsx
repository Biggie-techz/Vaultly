...
const FeatureCard = ({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-white shadow-xl shadow-gray-200/50 transition-all duration-500 hover:shadow-2xl hover:shadow-gray-200/70">
        {/* Background linear accent */}
        <div className="absolute inset-0 bg-linear-to-br from-gray-50/50 via-white to-gray-100/30" />
        ...
        <div className="relative flex flex-col gap-8 p-6 md:p-10 lg:flex-row lg:items-center lg:gap-12">
          ...
          <div className="flex-1 space-y-5">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-gray-600 transition-colors group-hover:bg-gray-900 group-hover:text-white">
            ...
            {/* Title */}
            <h3 className="text-2xl font-bold leading-tight text-gray-900 md:text-3xl lg:text-4xl">
              {feature.title}
            </h3>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button
                size="lg"
                className="group/btn bg-gray-900 text-white hover:bg-gray-800"
              >
                {feature.ctaPrimary}
          ...
          <div className="relative w-full overflow-hidden rounded-2xl lg:w-1/2">
            <div className="absolute inset-0 z-10 bg-linear-to-t from-gray-900/60 via-gray-900/10 to-transparent" />
            <motion.img
...
const SectionThree = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-linear-to-b from-gray-50 via-white to-gray-100 py-20 md:py-28">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-1/4 top-1/4 h-96 w-96 rounded-full bg-gray-200/30 blur-3xl" />
        <div className="absolute -right-1/4 bottom-1/4 h-96 w-96 rounded-full bg-gray-200/30 blur-3xl" />
      </div>
